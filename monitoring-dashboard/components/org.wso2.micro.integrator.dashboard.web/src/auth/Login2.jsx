        ...
        AuthManager.authenticate(host, port, username, password, rememberMe)
            ...
            .catch((error) => {
                ...
                if (error.response && error.response.status === 401)  {
                    ...
                    errorMessage = 'Error occurred in communication. Please verify the server is running with Management API enabled and the certificate is trusted by the browser';
